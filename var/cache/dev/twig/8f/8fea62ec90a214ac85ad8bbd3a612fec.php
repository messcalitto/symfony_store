...
class __TwigTemplate_eb242d391b58c7a6ed8759917109f2b3 extends Template
{
    private $source;
    private $macros = [];
...
<style>
    ...
    <div class=\"my-5 flex flex-col mx-auto pt-0\">
        <div class=\"max-w-md mt-6 p-5 py-4 bg-white border overflow-hidden rounded-lg m-auto text-left\">
    ...
    ";
        // line 30
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 30, $this->source); })()), 'form_start');
        echo "
        ";
        // line 31
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 31, $this->source); })()), "name", [], "any", false, false, false, 31), 'row');
        echo "
        ";
        // line 32
...
";
    ...
    {
        return array (  151 => 39,  145 => 36,  142 => 35,  140 => 33,  136 => 32,  132 => 31,  128 => 30,  123 => 28,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "C:\\work\\symfony\\store\\templates\\registration\\register.html.twig");
    }
}
